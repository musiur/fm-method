...
import { TypeDetails, TypeDetailsFAQ, TypeDetailsInstructor, TypeDetailsSyllabus } from "./type-details";
    ...
    const tabsData = [
        {
            ...
            content: !props.instructor ? null : <Instructor {...props.instructor as TypeDetailsInstructor} />
        },
        {
            id: 2,
            title: "কোর্সটি করে যা শিখবেন",
            content: !props.what_you_will_learn ? null : <Outcomes {...props.what_you_will_learn as Array<string>} />
        },
        {
            id: 3,
            title: "কোর্স সিলেবাস",
        ...
        },
        {
            ...
            content: !props.more_details ? null : <Indetails {...props.more_details as TypeDetailsFAQ[]} />
        },
        {
            id: 5,
