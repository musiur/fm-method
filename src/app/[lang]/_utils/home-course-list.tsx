...
const HomeCourseList = async () => {
  ...
  return <div className="section bg-darkBrand">
    <div className="container space-y-8">
      <div className="space-y-4 [&>*]:text-white">
        <p>পুরো মাস জুড়ে FM Method নির্দিষ্ট কোর্সসমূহ পেয়ে যান বিশেষ মূল্যে। এবার শেখার শুরু হোক FM Method সাথে!</p>
        <h2 className="text-2xl md:text-4xl font-bold">স্কিল ডেভেলপমেন্টের নির্দিষ্ট কোর্সে দারুণ ছাড়!</h2>
      </div>
