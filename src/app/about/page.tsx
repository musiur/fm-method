...
import { BasicIcon, IntermediateIcon, IeltsIcon, AdvancedIcon } from "@/components/pages/home";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 items-center">
          ...
          <div className="my-auto">
            ...
            <p className="text-gray-600 mb-8">
              এফএম মেথড হলো বাংলা ভাষাভাষী মানুষদের ইংরেজি শেখানোর একটি বৈজ্ঞানিক পদ্ধতি। এটি ইংরেজি
              শেখার একটি অনন্য এবং কার্যকর উপায়।
            </p>
